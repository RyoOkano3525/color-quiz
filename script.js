...
const allQuestions = [
  ...
  { question: "松田好花", correctAnswer: ["パールグリーン", "サクラ"] },
...
function showQuestion() {
  ...
  // ランダムな問題文と答えを表示します
  // question.textContent = allQuestionsText[randomIndex];
  question.textContent = allQuestions[randomIndex].question;
  // answer.textContent = allCorrectAnswers[randomIndex];
  answer.textContent = allQuestions[randomIndex].correctAnswer;
